        ...
        <div class="boutonDetail">
          ...
          <BaseButton variant="quatrieme" @click="goBack">
            <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
              aria-label="Fleche du retoure en arriere d'une page.">
          ...
          <div class="coteBouton">
            ...
            <BaseButton variant="quatrieme" @click="toggleEdit">
              {{ isEditing ? "💾" : "🖍️" }}
            </BaseButton>
            <BaseButton variant="quatrieme" @click="deleteMemoryPrompt">
              🗑️
            </BaseButton>
          </div>
        </div>
